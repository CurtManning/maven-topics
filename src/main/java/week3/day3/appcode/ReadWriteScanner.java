...
public class ReadWriteScanner {
	...
	public static void readWriteScanner(String inputFile, String outputFile) throws IOException {
		...
		try {
			sInputStream = new Scanner(new BufferedReader(new FileReader(inputFile)));
	...
	public static void main(String[] args) throws IOException {
		...
		readWriteScanner(inputFile, outputFile);
	}
}
