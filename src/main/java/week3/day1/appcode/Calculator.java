...
* will take input from the dataprovider 
like  this { 2, 5, 7 } , 2 and 5 are input values and 7 is the expected result
I want to pass 3 sets of inputs to dataprovider.
{ 2, 5, 7 }, { 3, 7, 10 }, { 4, 5, 9 } 
**/
